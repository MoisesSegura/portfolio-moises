...
title: OIMA web page
date: 01-03-2024
description: website developed with the framework laravel for the Organización de Información de Mercados de las Américas (OIMA)
image: ../assets/spectre.png
link: https://github.com/MoisesSegura/oima/tree/moises_branch
info:
  - text: GitHub
    link: https://github.com/MoisesSegura/oima?tab=readme-ov-file
    icon:
      type: lucide
      name: github
---
